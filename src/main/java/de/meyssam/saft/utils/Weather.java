...
public class Weather {
    ...
    private final PrintStream file = new PrintStream(new FileOutputStream("Forecast.txt"));
    private final PrintStream futureFile = new PrintStream(new FileOutputStream("Future.txt"));
    ...
    private final String D1 = format.format(day1);

    // date for Day 2
    public Date day2 = new Date(day1.getTime() + (1000 * 60 * 60 * 24));
    private final String D2 = format.format(day2);

    // date for Day 3
    public Date day3 = new Date(day2.getTime() + (1000 * 60 * 60 * 24));
    private final String D3 = format.format(day3);

    // date for Day 4
    public Date day4 = new Date(day3.getTime() + (1000 * 60 * 60 * 24));
    private final String D4 = format.format(day4);
